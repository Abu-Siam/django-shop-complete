    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('Washington', 'Washington'), ('Oregon', 'Oregon'), ('California', 'California'), ('Nevada', 'Nevada'), ('Arizona', 'Arizona'), ('New Mexico', 'New Mexico')], max_length=200)),
